...
BEGIN_EVENT_TABLE(CA_GUIDialog, wxDialog)
    EVT_CLOSE(CA_GUIDialog::OnClose)
    EVT_BUTTON(idBtnQuit, CA_GUIDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, CA_GUIDialog::OnAbout)
END_EVENT_TABLE()

CA_GUIDialog::CA_GUIDialog(wxDialog *dlg, const wxString &title)
...
CA_GUIDialog::~CA_GUIDialog()
{
}

void CA_GUIDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void CA_GUIDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void CA_GUIDialog::OnAbout(wxCommandEvent &event)
{
